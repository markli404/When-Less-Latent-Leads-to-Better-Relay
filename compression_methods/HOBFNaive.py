...
class HOBFNaive(BaseKVCompressor):
    """
    HOBF naive variant with metric collection.

    This mirrors HOBFMetric but uses the discarded values directly,
    disables attention-based scaling, and uses the maximum available
    PCA rank.
    """
